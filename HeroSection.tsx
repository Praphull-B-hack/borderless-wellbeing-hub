...
import { ArrowRight, Globe, Users, Brain, ShieldPlus, HeartPulse } from 'lucide-react';
...
const HeroSection: React.FC<HeroSectionProps> = ({ onGetStarted }) => {
  ...
  const floatingIcons = [
    ...
    { icon: Brain, delay: 0.6, x: -100, y: -40 },
    { icon: ShieldPlus, delay: 0.8, x: 80, y: 120 },
    { icon: HeartPulse, delay: 1.0, x: -120, y: 60 }
  ];
    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center hero-professional-gradient overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            {[
              { number: "1M+", label: t('stats.members') },
