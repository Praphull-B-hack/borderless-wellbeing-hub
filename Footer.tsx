    ...
    <footer className="bg-gray-900 dark:bg-black text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h3 className="text-lg dark:text-white font-bold bg-gradient-to-r from-wellness-purple-600 to-wellness-blue-600 bg-clip-text text-transparent">
              Quick Links
            </h3>
          ...
          {/* Services */}
          <div className="space-y-4">
            <h3 className="text-lg dark:text-white font-bold bg-gradient-to-r from-wellness-purple-600 to-wellness-blue-600 bg-clip-text text-transparent">Services</h3>
            <ul className="space-y-2">
          ...
          {/* Contact & Language */}
          <div className="space-y-4">
            <h3 className="text-lg dark:text-white font-bold bg-gradient-to-r from-wellness-purple-600 to-wellness-blue-600 bg-clip-text text-transparent">Contact Us</h3>
            ...
            {/* Language Selector */}
            <div className="pt-4">
              <h4 className="text-sm dark:text-white font-semibold bg-gradient-to-r from-wellness-purple-600 to-wellness-blue-600 bg-clip-text text-transparent mb-2">Language</h4>
              <LanguageSelector />
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 Borderless Wellbeing. All rights reserved.
            </p>
