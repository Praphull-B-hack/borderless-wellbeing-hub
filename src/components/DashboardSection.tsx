      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
              ...
              <div className="mt-4 sm:mt-0">
                <div className="flex items-center space-x-2 bg-gradient-to-r from-wellness-green-100 to-wellness-blue-100 dark:from-wellness-green-900/30 dark:to-wellness-blue-900/30 px-4 py-2 rounded-lg backdrop-blur-sm">
                  ...
                  />
                  <span className="text-wellness-green-700 dark:text-wellness-green-300 font-medium">All Systems Balanced</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {[
              { icon: Activity, label: 'Health Tracker', color: 'wellness-blue' },
              { icon: Calendar, label: 'Wellness Metrics', color: 'wellness-green' },
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 dark:text-gray-300 mr-20">Active Self-Care Time</span>
                      <span className="font-semibold text-gray-900 dark:text-white">6.5 hours this week</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 dark:text-gray-300">Ongoing Care Plans</span>
                      <span className="font-semibold text-gray-900 dark:text-white me-6">4 programs </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 dark:text-gray-300">Healthy Habit Streak</span>
                      <span className="font-semibold text-wellness-green-600 dark:text-wellness-green-400">🔥  12 days of consistent routines</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex justify-between mb-1">
                        <span className="text-gray-600 dark:text-gray-300 text-sm">Nutrition</span>
                    ...
                    <div>
                      <div className="flex justify-between mb-1">
                        <span className="text-gray-600 dark:text-gray-300 text-sm">Recovery</span>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900 dark:text-white">Virtual Therapy Session</p>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900 dark:text-white">Nutrition Workshop</p>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900 dark:text-white">Physiotherapy Review</p>
